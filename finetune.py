...
parser.add_argument("--exp_name", help = "experiment name, for checkpoint name", default = datetime.now().strftime("%Y-%m-%d_%H:%M:%S"),
                    type=str)
parser.add_argument("--mode", help = "pretrain or finetune", default = "finetune",
                    type=str)
parser.add_argument("--num_files", help = "number of files used in training", default = 521,
                    type=int)
parser.add_argument("--batch_size", help = "batch_size training", default = 196,
                    type=int)
parser.add_argument("--epochs", help = "epochs training", default = 8,
                    type=int)
parser.add_argument("--vocab_size", help = "vocab size model and tokenizer", default = 64103,
                    type=int)
parser.add_argument("--learning_rate", help = "learning rate training", default = 0.001,
                    type=float)
parser.add_argument("--path_to_ckpt", help = "continue from pretrain model",
                    type=str)                    
